...
import random
import urllib
url = 'https://www.aacr.org/meeting/aacr-annual-meeting-2020/aacr-virtual-annual-meeting-i/'
...
name_list = soup.find('div', {'class': 'meeting-links-wrap'})

# 找出col-sm-8 report-list下的所有li标签
projects = name_list.find_all('li')
projects_titles = []
# projects_source = []
...
for i in projects:
    try:
        # 提取项目标题
        titles = i.find('a').get_text().strip()
        # 提取项目倍数
