...
for local in locals:
    ...
    for Type in local_types:
        print(Type.get_attribute("innerText"))
...
# local_types = driver2.find_elements_by_xpath("//div[@class='toggle']/ol/li[1]/b")
# xpath绝对路径
# local_types = driver2.find_elements_by_xpath("//div[2]/div[2]/div/div[2]/div/ul/li/div[2]/ol/li[1]/b")

# js = driver2.find_elements_by_xpath("//div[2]/div[2]/div/div[2]/div/ul/li[1]/div[2]")[0].style.display="block"
